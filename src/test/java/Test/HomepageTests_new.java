...
public class HomepageTests_new extends BaseTest {
    ...
    public void new_scrollDown(){
        ...
        loginPage.openPage();
        HomePage homePage = loginPage.login("testpro.user02@testpro.io","te$t$tudent02");
        homePage.createNewPlaylist("Zelda");
        homePage.leftHandScrollDown("Zelda");
        homePage.renamePlayList("Zelda","newZelda");
        Assert.assertTrue(homePage.isPlaylistCreated("newZelda"));
